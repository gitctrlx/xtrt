...
def modify_yolo_onnx_model(input_model_path, output_model_path):
    ...
    decode_out_0 = onnx_gs.Variable("DecodeNumDetection", dtype=np.int32)
    decode_out_1 = onnx_gs.Variable("DecodeDetectionBoxes", dtype=np.float32)
    decode_out_2 = onnx_gs.Variable("DecodeDetectionScores", dtype=np.float32)
    decode_out_3 = onnx_gs.Variable("DecodeDetectionClasses", dtype=np.int32)
...
# usage
# python tools/modify_onnx.py weights/yolov5s.onnx weights/yolov5s_output.onnx
