...
# usage demo: pytho3n tools/create_filelist.py ./calibdata ./calibdata filelist.txt 200
# python3 scripts/create_filelist.py data/coco/val2017 data/coco filelist.txt 100
